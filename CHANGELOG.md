...
- Updated the SECURITY policy contact to dimly@brianpoon.com for consistency with the README.
...
- Documented the localization workflow for contributors in `CONTRIBUTING.md`.
- Added French (fr) localization covering all extension strings.
- Added German (de) localization covering all extension strings.
